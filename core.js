function generateRacks(datacenter, rowMax, rackMax) {
    var countRow;
    var countRack;
    var rackName;
    var blenderXCenter;
...
function generateHardware(datacenter, rackData, sledMax) {
    var blenderPlaneHeight;
    var blenderPlaneWidth;
    var blenderXCenter;
    var blenderYCenter;
    var blenderZCenter;
    var blenderZRotation;
    var name;
    var planeDimensions = {};
    var rackU;
    var serverLoop;
 ...
 */
function calculateRackMounted(rack) {
    var blenderPlaneWidth;
    var blenderXCenter;
    var blenderYCenter;
    var blenderZRotation;
...
function calculateChassisSled(rack, rackU, uSlot) {
    var blenderPlaneHeight;
    var blenderPlaneWidth;
    var rackBase;
    var rackMountWidth;
...
function init() {
    ...
    playerObjects.forEach(function (object) { return player.add(object); });
}
...
function render() {
    ...
    if (session) {
        ...
        if (sources) {
            var controllerZero = sources[0];
            // check that input source zero exists
            if (controllerZero) {
                var gamepad = controllerZero.gamepad;
